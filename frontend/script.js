...
const translations = {
    ...
    pt: {
        ...
        vertys_bullet1: "Reestruturação e migração para a AWS da integração legada entre o ERP Sankhya e as plataformas de vendas utilizando Python e serviços serverless, reduzindo o tempo médio de sincronização em 93%, de 7,5 minutos para 30 segundos; desenvolvimento de um portal web seguro utilizando Cognito, API Gateway, Lambda, CloudFront e S3 para monitoramento de pedidos e dados da integração.",
